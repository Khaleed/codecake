...
describe("getMaxProfit", () => {
    describe("array with less than two stock prices", () => {
        it("throws an error", () => {
    ...
    describe("array with two or more stock prices that stay the same", () => {
        it("produces best profit from one purchase and one sale of an apple stock", () => {
            expect(getMaxProfit([10, 10, 10, 10, 10, 10])).toEqual(0);
        });
    });
    describe("array with two or more stock prices that keep going down", () => {
        it("produces best profit from one purchase and one sale of an apple stock", () => {
